        ...
        <aside
            ...
            <div class="relative pl-3 my-5 overflow-y-scroll">
                <div class="flex flex-col w-full font-medium">
                    ...
                    @if (in_array(Auth::user()->role->name, ['ADMIN', 'CAJERO']))
                        <div>
                            <span
                                class="select-none flex items-center px-4 py-[.775rem] cursor-pointer my-[.4rem] rounded-[.95rem]">
                                <a href="{{ route('sales.index') }}"
                                    class="flex items-center flex-grow text-[1.15rem] dark:text-neutral-400/75 text-stone-500 hover:text-dark">Ventas</a>
                            </span>
                        </div>
                    @endif
                        ...
                        <div>
                            <span
                                ...
                                <a href="{{ route('cash.index') }}"
                                    class="flex items-center flex-grow text-[1.15rem] dark:text-neutral-400/75 text-stone-500 hover:text-dark">Caja</a>
                            </span>
                        </div>
                    @endif


                    @if (in_array(Auth::user()->role->name, ['ADMIN', 'INVENTARIO', 'ALMACENERO']))
                        <div>
                            <span
                                class="select-none flex items-center px-4 py-[.775rem] cursor-pointer my-[.4rem] rounded-[.95rem]">
                                <a href="{{route('stocktaking.index')}}"
                                    class="flex items-center flex-grow text-[1.15rem] dark:text-neutral-400/75 text-stone-500 hover:text-dark">Inventario</a>
                            </span>
                        </div>
                    @endif
                    ...
                    <div class="block pt-5 pb-[.15rem]">
                        <div class="px-4 py-[.65rem]">
                            <span
                                class="font-semibold text-[0.95rem] uppercase dark:text-neutral-500/80 text-secondary-dark">Aplicación</span>
                        </div>
                    </div>
                        ...
                        <div>
                            <span
                                ...
                                <a href="{{ route('users.index') }}"
                                    class="flex items-center flex-grow text-[1.15rem] dark:text-neutral-400/75 text-stone-500 hover:text-dark">Usuarios</a>
                            </span>
                        </div>
                    @endif
                        ...
                        <div>
                            <span
                                ...
                                <a href="{{route('report.index')}}"
                                    class="flex items-center flex-grow text-[1.15rem] dark:text-neutral-400/75 text-stone-500 hover:text-dark">Reportes</a>
                            </span>
                        </div>
                    @endif
